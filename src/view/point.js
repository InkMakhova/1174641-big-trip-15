...
export const createPointTemplate = (dataPoint) => {
  ...
  return `<li class="trip-events__item">
    <div class="event">
      <time class="event__date" datetime=${formateDateTime(dataPoint.dateFrom, formatsDateTime.yearMonthDay)}>${formateDateTime(dataPoint.dateFrom, formatsDateTime.monthDay)}</time>
      ...
      <button class="event__favorite-btn${dataPoint.isFavorite === true ? ' event__favorite-btn--active' : ''}" type="button">
